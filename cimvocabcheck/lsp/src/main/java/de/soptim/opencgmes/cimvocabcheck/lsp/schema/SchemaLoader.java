...
/**
 * Builds a {@link RdfsSchemaIndex} from an {@link CimvocabcheckConfig}, delegating to
...
public final class SchemaLoader {
     ...
     */
    public static Optional<SchemaAndSources> loadWithSources(CimvocabcheckConfig config, Path configBase)
