...
package de.soptim.opencgmes.cimvocabcheck.core.explain;

/**
 * The static "explain" of a SPARQL query: its normalized text plus the algebra plan, both as Jena
 * compiles it and as Jena's static optimizer rewrites it. This is the CIMVocabCheck equivalent of
 * {@code arq.qparse --print=query,op,opt} — no data is executed.
 *
