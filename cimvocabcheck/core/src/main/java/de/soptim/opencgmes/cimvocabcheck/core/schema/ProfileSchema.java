 ...
 *
 * <p>The {@link #classes()} and {@link #properties()} sets are always indexed. The three semantic
 * maps ({@link #propertyDomain()}, {@link #propertyRange()}, {@link #subClassOf()}) are optional —
 * callers that only need existence checks can use {@link #minimal(VersionIri, Set, Set)} to skip
 * them.
 *
...
public record ProfileSchema(
  ...
  public static ProfileSchema minimal(
      VersionIri versionIri, Set<Node> classes, Set<Node> properties) {
