...
| **CIMNotebook: Send Schema to RDFArchitect**          | Imports the project's schema into RDFArchitect as a read-only workspace and opens it.          |
