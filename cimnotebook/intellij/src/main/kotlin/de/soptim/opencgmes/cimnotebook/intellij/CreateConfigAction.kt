 ...
 * the language server's `cimvocabcheck.createConfig` command so the CLI and editors stay in sync, with a
...
class CreateConfigAction : AnAction() {
    ...
    companion object {
        ...
        private val FALLBACK =
            ...
            {
              "cimvocabcheck": {
                // Point CIMVocabCheck at your CGMES profiles; without them validation is syntax-only.
